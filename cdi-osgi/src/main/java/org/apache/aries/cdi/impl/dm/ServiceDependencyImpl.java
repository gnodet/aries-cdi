 ...
 */
public class ServiceDependencyImpl extends AbstractDependency<ServiceDependencyImpl> implements org.apache.aries.cdi.impl.dm.tracker.ServiceTrackerCustomizer {
    ...
    public ServiceDependencyImpl setDebug(String debugKey) {
    	m_debugKey = debugKey;
    	m_debug = true;
    	return this;
    }
    ...
    public ServiceDependencyImpl setCallbacks(Object instance, String added, String changed, String removed, String swapped) {
        setCallbacks(instance, added, changed, removed);
        m_swap = swapped;
        return this;
    }
    
    public ServiceDependencyImpl setCallbacks(String added, String changed, String removed, String swapped) {
        setCallbacks(added, changed, removed);
        m_swap = swapped;
        return this;
    }
		
    public ServiceDependencyImpl setDefaultImplementation(Object implementation) {
        ensureNotActive();
        m_defaultImplementation = implementation;
        return this;
    }   

   	public ServiceDependencyImpl setService(Class<?> serviceName) {
        setService(serviceName, null, null);
        return this;
    }

    public ServiceDependencyImpl setService(Class<?> serviceName, String serviceFilter) {
        setService(serviceName, null, serviceFilter);
        return this;
    }

    public ServiceDependencyImpl setService(String serviceFilter) {
    ...
    public ServiceDependencyImpl setService(Class<?> serviceName, ServiceReference serviceReference) {
		...
		try {
		    ...
		    if (m_component.isActive()) {
                m_component.getLogger().warn("could not handle service dependency for component %s", e,
                        ((ComponentImpl) m_component).getClassName());
		    }
		    return null;		    
		}
	}
    ...
    @Override
    public ServiceDependencyImpl createCopy() {
    ...
    public void invoke(String method, Event e, Object[] instances) {
        ...
        m_component.invokeCallbackMethod(instances, method,
            new Class[][]{
                {ComponentImpl.class, ServiceReference.class, m_trackedServiceName},
                {ComponentImpl.class, ServiceReference.class, Object.class},
                {ComponentImpl.class, ServiceReference.class},
                {ComponentImpl.class, m_trackedServiceName},
                {ComponentImpl.class, Object.class},
                {ComponentImpl.class},
                {ComponentImpl.class, Map.class, m_trackedServiceName},
    ...
    public void invokeSwap(String swapMethod, ServiceReference previousReference, Object previous,
    	...
    	if (m_debug) {
    		System.out.println("invoke swap: " + swapMethod + " on component " + m_component + ", instances: " + Arrays.toString(instances));
    	}
    	try {
		m_component.invokeCallbackMethod(instances, swapMethod,
				new Class[][]{
            		...
            		{ComponentImpl.class, m_trackedServiceName, m_trackedServiceName},
            		{ComponentImpl.class, Object.class, Object.class},
            		{ComponentImpl.class, ServiceReference.class, m_trackedServiceName, ServiceReference.class, m_trackedServiceName},
            		{ComponentImpl.class, ServiceReference.class, Object.class, ServiceReference.class, Object.class}},
