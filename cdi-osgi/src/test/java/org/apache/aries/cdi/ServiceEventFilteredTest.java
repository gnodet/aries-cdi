...
public class ServiceEventFilteredTest extends AbstractTest {
    ...
    public static class ServiceEventReceiver {
        ...
        public void added(@Observes @ReferenceAdded @Filter("(foo=bar)") MyService service) {
            System.err.println("ReferenceAdded");
            added.incrementAndGet();
        }
        public void removed(@Observes @ReferenceRemoved @Foo ReferenceEvent<? extends MyService> service) {
